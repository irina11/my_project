...
class PostsController extends ControllerBlog {
    ...
    public function view(Request $r) {
        ...
        echo $this->render('post_default', $this->formData($postsListPrew));
    }
    ...
    public function delete(Request $r) {
        ...
        $this->controlisLoggedUser('', 'message', 'text=authRequired');
        $this->controlParam($post_id, '', 'message', 'text=nopost');
    ...
    public function edit(Request $r) {
        ...
        $this->controlParam($post, '', 'message', 'text=nopost');
        ...
        echo $this->render('add_edit', $data);
    }
    ...
    public function add_edit(Request $r) {
        ...
        if (empty($post['title']) || empty($post['content'])) {
            $this->redirect('', 'message', 'text=noedit');
        }
